  ...
  return (
    <DefaultLayout>
      <div className="d-flex justify-content-between">
        <h1 style={{ color: 'var(--text-primary)' }}>Past Bills List</h1>
      </div>

      <Table columns={columns} dataSource={billsData} bordered rowKey="_id" scroll={{ x: 600 }} />
        ...
        >
          ...
          <div id="invoice-POS" ref={componentRef}>
            <center id="top">
              ...
              <div className="info">
                <h2>Ravindra Pos</h2>
                <p> Contact : 7706876498| Noida Uttar Pradesh</p>
              </div>
              {/*End Info*/}
            </center>
            {/*End InvoiceTop*/}
